...
(function () {
    ...
    */
    ...
    //这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径） //URL = '/UEditorWeb/UEditor/'; ; 
    //这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径） 
    var pathName = window.document.location.pathname;
    var projectName = pathName.substring(0, pathName.substr(1).indexOf('/') + 1);
    URL = projectName + "/Plugin/ueditor/";
    var upLoadPath = projectName;
    ...
    */
    window.UEDITOR_CONFIG = {
        ...
        , scrawlPath: upLoadPath                            //图片修正地址，同imagePath

        //附件上传配置区
        , fileUrl: URL + "net/fileUp.ashx"               //附件上传提交地址
        , filePath: upLoadPath             //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

        //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        , catcherUrl: URL + "net/getRemoteImage.ashx"   //处理远程图片抓取的地址
        , catcherPath: upLoadPath                //图片修正地址，同imagePath
        ...
        , imageManagerPath: upLoadPath                                //图片修正地址，同imagePath
        ...
        , videoPath: upLoadPath                 //附件修正地址，同imagePath
